...
Fork your own copy of raiders168/Auto-OpenWrt
Code
Issues
Pull requests
1
...
Security
Insights
Auto-OpenWrt/diy-6.1-part2.sh
@raiders168
raiders168 Update diy-6.1-part2.sh
Latest commit 3e3f25e on Jan 3
 History
 1 contributor
39 lines (33 sloc)  1.78 KB
...
########### 更改大雕源码（可选）###########
sed -i 's/KERNEL_PATCHVER:=6.1/g' target/linux/x86/Makefile
...
Blog
About
Auto-OpenWrt/diy-6.1-part2.sh at main · raiders168/Auto-OpenWrt
